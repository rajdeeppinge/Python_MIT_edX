...
class edx(object):
    ...
    def setGrade(self, grade, course="6.01x"):
        ...
        for courseInfoObj in self.myCourses:
            if courseInfoObj.courseName == course:
                courseInfoObj.setGrade(grade)
    ...
    def setPset(self, pset, score, course="6.00x"):
        ...
        for courseInfoObj in self.myCourses:
            if courseInfoObj.courseName == course:
                courseInfoObj.setPset(pset, score)
    ...
    def getPset(self, pset, course="6.00x"):
        ...
        for courseInfoObj in self.myCourses:
            if courseInfoObj.courseName == course:
                return courseInfoObj.getPset(pset)
